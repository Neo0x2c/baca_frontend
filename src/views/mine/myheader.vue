<template>
  <div class="myheadercontain">
    ...
    <div class="bitinfo">
      ...
      >
        <span class="sub_nav_left">BCT$</span
        ><span class="sub_nav_right">{{ userObj.total.toFixed(4) }}</span>
      </div>
      <div class="parent_nav">
        <span class="sub_nav_left">Staked</span
        ><span class="sub_nav_right">{{ userObj.stake }}</span>
      </div>
      <div class="parent_nav">
        <span class="sub_nav_left">Available</span
        ><span class="sub_nav_right">{{ userObj.money.toFixed(4) }}</span>
      </div>
    </div>
  </div>
</template>
